...
public class AncientsConfiguredFeature {
    ...
    public static void boostrap(Registerable<ConfiguredFeature<?, ?>> context){
        ...
        register(context, MYSTWOOD_KEY, Feature.TREE, new TreeFeatureConfig.Builder(
                ...
                new BendingTrunkPlacer(4,2,1,2, ConstantIntProvider.create(2)),

                BlockStateProvider.of(AncientsBlocks.MYSTWOOD_LEAVES),
                new CherryFoliagePlacer(ConstantIntProvider.create(2), ConstantIntProvider.create(4), ConstantIntProvider.create(4),
                        0.2f, 0.2f, 0.2f, 0.2f),
